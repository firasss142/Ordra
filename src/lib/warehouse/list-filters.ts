...
export type WarehouseHistoryKind = "all" | "print" | "scan" | "return";
...
export type WarehouseHistoryClearableKey = "kind" | "date" | "q";
...
export const warehouseHistoryQuerySchema = z.object({
  ...
  kind: z.enum(["all", "print", "scan", "return"]).default("all"),
